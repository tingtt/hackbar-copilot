...
func (s *recipeAdapterIn) ApplyGlassTypes(
...
func (s *recipeAdapterIn) ExtractGlassTypes(recipes []model.InputRecipe) []model.InputGlassType {
...
func (s *recipeAdapterIn) HasUpdateGlassTypes(inputGlassTypes []model.InputGlassType, currentGlassTypes map[string]recipe.GlassType) ([]recipe.GlassType, error) {
